...
class DBFirebase:
    def __init__ (self):
        self.config = {
        "apiKey": "AIzaSyCoDgMrviWD6aX1Zi1D-duoEbAdJogs31w",
        "authDomain": "database-2b3e6.firebaseapp.com",
        "databaseURL": "https://database-2b3e6.firebaseio.com/",
        "storageBucket": "database-2b3e6.appspot.com"
        }
    ...
    def lerRegistro(self,chave=''):
        self.userselect = self.db.child("clientes").get(chave)
